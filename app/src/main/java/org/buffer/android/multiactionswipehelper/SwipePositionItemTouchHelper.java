...
public class SwipePositionItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    private static final String TAG = "SwipePositionHelper";
     ...
     */
    public SwipePositionItemTouchHelper(Callback callback) {
        mCallback = callback;
    }
     ...
     *                     {@code null} if you want to remove SwipePositionItemTouchHelper from the current
     *                     RecyclerView.
     */
    ...
    private void postDispatchSwipe(final RecoverAnimation anim, final int swipeDir,
                                   final float horizontalTouchPosition) {
    ...
    public abstract static class Callback {
         ...
         * the new position.
         * <p>
         * If this method returns true, SwipePositionItemTouchHelper assumes {@code viewHolder} has been moved
